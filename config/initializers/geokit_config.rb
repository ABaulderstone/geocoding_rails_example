...
#Geokit::Geocoders::GoogleGeocoder.api_key = Rails.application.credentials.dig(:g_maps)
...
# Geokit::Geocoders::MapboxGeocoder.key = 'ACCESS_TOKEN'
 Geokit::Geocoders::OpencageGeocoder.key = Rails.application.credentials.dig(:open_cage)
